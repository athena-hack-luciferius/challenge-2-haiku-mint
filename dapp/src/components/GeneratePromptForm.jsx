...
export default function GeneratePromptForm({ onGeneratePrompt, id }) {
  return (
    <Box component="form" onSubmit={onGeneratePrompt} className="items-center align-middle flex flex-col">
        ...
        <TextField id="topic" label="The topic the haiku is about - think of it as a theme (sunset, flowers, colors...)" variant="outlined" className="my-4 self-center"
                   autoFocus sx={{ width: '70%' }}/>
        <TextField id="adjective" label="An adjective for the haiku. Can be used to determine the mood (sad, funny, mechanloic, ...)" variant="outlined" className="my-4 self-center"
         sx={{ width: '70%' }}/>
